package tremors.webapi1x.handler

import com.softwaremill.macwire.wire
import tremors.webapi1x.Marshalling.extractJSON
import tremors.webapi1x.crawler.CrawlerManager
import tremors.webapi1x.graboid.CrawlerDescriptorMapper
import tremors.webapi1x.toZIO
